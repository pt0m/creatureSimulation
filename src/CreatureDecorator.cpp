...
float CreatureDecorator::get_size() const {
    return this->decoree->get_size();
}
...
int CreatureDecorator::get_x() const {
    return this->decoree->get_x();
}

int CreatureDecorator::get_y() const {
    return this->decoree->get_y();
}

float CreatureDecorator::get_vx() const {
    return this->decoree->get_vx();
}

float CreatureDecorator::get_vy() const {
    return this->decoree->get_vy();
}
